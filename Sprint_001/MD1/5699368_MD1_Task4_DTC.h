...
class DTC{
    ...
    public:
        ...
        // constructors
        DTC();
        DTC(std::string code_,std::string description_,bool active_,int occurenceCount_,std::time_t lastOccurenceTime_,SeverityLevel severityLevel_,bool confirmed_,bool pending_,bool milOn_,std::string system_,std::string origin_);
        DTC(const DTC& other);
