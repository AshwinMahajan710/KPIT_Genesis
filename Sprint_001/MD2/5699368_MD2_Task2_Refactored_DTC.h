...
public:
    // constructors
    DTC();
    DTC(const std::string& code_, const std::string& description_, bool active_, int occurenceCount_,
    ...
    // Additional method to get string value of severity
    std::string getSeverityString();

    // Additional methods for DTC
